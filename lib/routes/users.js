...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (basePath.match(/^\/me\/hives\/[^/]+$/) && method === 'PATCH') {
      ...
      if (updates.coordinates) user.ownedHives[hiveIndex].coordinates = updates.coordinates;
      if (updates.visibility) user.ownedHives[hiveIndex].visibility = updates.visibility;
