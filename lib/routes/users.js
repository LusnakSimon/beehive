...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (basePath === '/me/hives' && method === 'POST') {
      ...
      // Handle image (base64 data URL or external URL)
      if (req.body.image) {
        newHive.image = req.body.image;
      }
